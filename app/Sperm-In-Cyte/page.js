      ...
      <div className="mx-auto w-full max-w-7xl space-y-16 px-4 pb-12 pt-10 md:space-y-20 md:pb-16 md:pt-12">
        <div className="relative w-full overflow-hidden rounded-lg border-2 border-border-primary bg-white px-6 py-8 md:px-10 md:py-10 lg:px-12">
          <div className="pointer-events-none absolute inset-0 z-0 flex items-center justify-center">
            <Microscope className="h-40 w-40 text-brand-primary-tint md:h-52 md:w-52" />
          </div>

          <div className="relative z-10 flex flex-col gap-4 text-center">
            <h2 className="font-display text-2xl leading-snug md:text-3xl">
              Harness the power of artificial intelligence with{" "}
              Sperm <span className="font-bold text-brand-primary">In-Cyte</span>
            </h2>
            <p className="text-lg font-body leading-snug">
              Sperm In-Cyte revolutionizes bull fertility testing by automating
              semen analysis with advanced computer vision. It captures and
              analyzes microscopic sperm images with unmatched accuracy—delivering
              fast, reliable results to support better breeding decisions and
              long-term herd success.
            </p>
        ...
        <div className="flex w-full flex-col items-stretch gap-8 md:flex-row md:items-center md:gap-12 lg:gap-14">
          ...
          <div className="flex w-full min-w-0 flex-col items-center justify-center gap-4 md:basis-0 md:flex-[1]">
            <div className="relative flex h-28 w-full max-w-sm items-center justify-center md:h-32 md:max-w-none">
              <FileHeart className="h-24 w-24 text-brand-primary-tint md:h-28 md:w-28" />
              <FileHeart
        ...
        <section>
          <div className="relative mx-auto w-full max-w-3xl overflow-hidden rounded-lg border-2 border-border-primary bg-white px-6 py-8 md:px-10 md:py-10 lg:px-12">
            ...
            <p className="mt-3 text-lg font-body leading-snug">
              ...
              inefficiencies, and reduced productivity. Traditional bull breeding
              soundness exams (B.B.S.E.) are often manual, imprecise, and costly,
              making it difficult for cattle producers to accurately assess bull
              fertility. These outdated methods can miss subtle signs of
              infertility, resulting in longer calving seasons, lighter weaning
              weights, and inconsistent herd reproduction. The lack of standardized,
