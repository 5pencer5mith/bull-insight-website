...
export const morphologyH2 = "mt-4 mb-3 text-2xl font-bold text-blue-700 font-display";
...
export const learnMoreTitle = "m-0 text-base font-semibold text-blue-700";
...
export const iconLearnMore = "text-3xl align-middle text-blue-700";
